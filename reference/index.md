...
- [`create_kfold()`](https://stufield.github.io/wranglr/reference/create_kfold.md)
  [`is.k_split()`](https://stufield.github.io/wranglr/reference/create_kfold.md)
  [`analysis()`](https://stufield.github.io/wranglr/reference/create_kfold.md)
  [`assessment()`](https://stufield.github.io/wranglr/reference/create_kfold.md)
  : Create k-Fold Partitioning
- [`distinct_rows()`](https://stufield.github.io/wranglr/reference/distinct_rows.md)
  : Select Distinct Rows
- [`feature_matrix()`](https://stufield.github.io/wranglr/reference/feature_matrix.md)
  : Select the Feature Matrix
- [`group_labels()`](https://stufield.github.io/wranglr/reference/group_labels.md)
  : Return Grouping Labels
- [`rearrange()`](https://stufield.github.io/wranglr/reference/rearrange.md)
  : Rearrange Rows by Variables
- [`rename(`*`<list>`*`)`](https://stufield.github.io/wranglr/reference/rename.md)
...
- [`match_samples()`](https://stufield.github.io/wranglr/reference/match_samples.md)
...
- [`calc_cv()`](https://stufield.github.io/wranglr/reference/calc_cv.md)
...
- [`center_scale()`](https://stufield.github.io/wranglr/reference/center_scale.md)
  [`is_center_scaled()`](https://stufield.github.io/wranglr/reference/center_scale.md)
  [`undo_center_scale()`](https://stufield.github.io/wranglr/reference/center_scale.md)
  : Center and/or Scale Data
- [`cast_numeric()`](https://stufield.github.io/wranglr/reference/cast_numeric.md)
  : Convert Table Entries to Numeric
- [`create_recipe()`](https://stufield.github.io/wranglr/reference/create_recipe.md)
  [`bake_recipe()`](https://stufield.github.io/wranglr/reference/create_recipe.md)
  [`is.baked()`](https://stufield.github.io/wranglr/reference/create_recipe.md)
  [`convert_recipe()`](https://stufield.github.io/wranglr/reference/create_recipe.md)
  : Pre-processing Analysis Data
- [`get_recipe_params()`](https://stufield.github.io/wranglr/reference/get_recipe_params.md)
  : Get Parameters From A Recipe
- [`scale_features()`](https://stufield.github.io/wranglr/reference/scale_features.md)
  : Scale/transform Features (variables)
- [`rebalance()`](https://stufield.github.io/wranglr/reference/rebalance.md)
...
- [`get_anno()`](https://stufield.github.io/wranglr/reference/anno.md)
  [`grep_anno()`](https://stufield.github.io/wranglr/reference/anno.md)
...
- [`simdata`](https://stufield.github.io/wranglr/reference/simdata.md) :
