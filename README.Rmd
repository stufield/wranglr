...
apply(feature_meta(scaled), 2, mean) |> sum()  # mean = 0
apply(feature_meta(scaled), 2, sd)             # sd = 1
...
* `lookupAnnotations()`
```{r seqLookup}
seqs <- withr::with_seed(101, sample(names(sample.adat), 10L))
seqs
